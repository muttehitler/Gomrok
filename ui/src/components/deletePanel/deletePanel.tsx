...
export const DeletePanel: FC<DeletePanelProp> = ({ id, visableState, name }: DeletePanelProp) => {
                ...
                <div className="relative p-4 w-full max-w-md max-h-full">
                    <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                        ...
                        <div className="p-4 md:p-5 text-center">
                            ...
                            <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">{sprintf(t('if-you-are-sure-delete-panel'), '"' + name + '"')}</h3>
                            ...
                            <button onClick={deletePanelHandler} data-modal-hide="popup-modal" type="button" className={(isButtonVisable ? "inline-flex" : "hidden") + " text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm items-center px-5 py-2.5 text-center"}>
                                {t('yes-im-sure')}
                            </button>
