...
export default function User() {
    ...
    useEffect(() => {
        (async () => {
            ...
            const result = JSON.parse(await getUserList({ csrf: generateCsrfToken(await getCookieCSRF() ?? ''), startIndex: (currentPage - 1) * pageSize, limit: pageSize, order: -1 }))
    ...
    return (
        <Page back={true}>
            ...
            <div className='container'>
                ...
                <Pagination currentPageState={[currentPage, setCurrentPage]} pageCount={Math.ceil(usersLength / pageSize)} key={"pagination"} />
            </div>
        </Page>
    );
}
